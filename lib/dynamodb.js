...
function DynamoDB(s, dataSource) {
    ...
    var i, n;
    this.name = 'dynamodb';
    this.tableNamePrefix = s.tableNamePrefix;
    this._models = {};
    this._tables = {};
...
exports.initialize = function initializeSchema(ds, cb) {
    ...
    if (ds.settings) {
        ...
        s.tableNamePrefix = ds.settings.tableNamePrefix || '';
    } else {
...
DynamoDB.prototype.define = function (descr) {
    ...
    // Assign table name
    tableParams.TableName = this.tableNamePrefix + (descr.settings.table || modelName);
